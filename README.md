...
## 📦 Installazione
1. Apri Chrome/Edge/Firefox e vai su `chrome://extensions/`
2. Cerca 'nome'.
3. Clicca su installa estensione.

## 📝 Utilizzo
[Dopo averla installata l'estensione si attiva ogni volta che si apre una pagina web di un chatbot e carica il modello in locale, dopo il caricamento del modello essa è pronta ad analizzare i dati.]

## 📜 Licenza
[Aggiungi il tipo di licenza, es: MIT]
